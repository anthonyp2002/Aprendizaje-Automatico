...
public class SecondActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "5d5b51b47c9617eb41b5f0013bb69c64f2985673";
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            // Llamar a método para guardar los datos en la base de datos
    ...
    private void saveDataToDatabase(String name, String imageUrl) {
        ...
        // Crea un nuevo documento con un ID generado automáticamente en la colección "Predicciones"
        ...
        // Guarda el documento en la colección "Predicciones" con el ID generado
    ...
    protected void onResume() {
        ...
        if (imagePath != null) {
           ...
           // removeBackground(imagePath,outputImagePath.getAbsolutePath());
            ImageView imageView = findViewById(R.id.image_view);
            TextView textResult = findViewById(R.id.textView4);
            Bitmap bitmap = BitmapFactory.decodeFile(imagePath);
            //Bitmap bitmap2 = BitmapFactory.decodeFile(outputImagePath.getAbsolutePath());
